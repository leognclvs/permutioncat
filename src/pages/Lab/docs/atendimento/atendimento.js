        ...
        <Flex>
            <Box className='sidebar' style={{ width: '20%' }}>
                <div className='sidebar-items'>
                    ...
                    <button className='item' onClick={() => setPage(6)}>Leito Misto Polidor</button>
                    <button className='item' onClick={() => setPage(7)}>Aferição do Condutivímetro</button>
                    <button className='item' onClick={() => setPage(8)}>Sistema de Desinfecção por UV</button>
                </div>
            </Box>
            <Box style={{ width: '60%' }}>
                {loading && <p>Loading...</p>}
